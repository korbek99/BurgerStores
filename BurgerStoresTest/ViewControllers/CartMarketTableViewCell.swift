...
import UIKit
struct CartMarketTableViewModel {
    let name: String
    let title: String
    let images: String
    let precio: String
...
class CartMarketTableViewCell: UITableViewCell {
    ...
    func configure(_ model: CartMarketTableViewModel) {
